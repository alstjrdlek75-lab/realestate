...
const NAVER_NEWS_ARTICLES: NaverArticle[] = [
  {
    id: "news-officetel-column",
    category: "POLICY",
    categoryLabel: "부동산 심층 칼럼",
    title: "[부동산 칼럼] 살기는 편한데 사기는 꺼려지는 오피스텔, 왜 자산가치는 아파트처럼 오르지 않을까?",
    summary: "역세권 입지와 우수한 보안, 풀옵션 빌트인으로 1~2인 가구의 실거주 만족도가 최고인 오피스텔. 하지만 '전·월세로 살기만(Live) 하고 매매(Buy)는 절대 하지 마라'는 시장 격언이 나오는 4대 구조적 이유를 심층 분석합니다.",
    contentParagraphs: [
      ...
      "1. 토지 지분(대지지분)의 절대적 부족\n부동산 가격 상승의 본질은 감가상각되는 ‘건물’이 아니라 영구적인 ‘땅(토지)’의 가치 상승에 있습니다. 오피스텔은 상업지역이나 준주거지역의 높은 용적률을 활용해 좁은 토지 위에 고층으로 빽빽하게 짓기 때문에, 세대당 배분되는 대지지분이 아파트에 비해 턱없이 적습니다. 건물이 노후화될수록 건물 가치는 0에 수렴하는데, 이를 방어해 줄 토지 지분이 작아 시간이 흐를수록 시세가 정체되거나 하락하기 쉽습니다.",
      "2. 재건축·리모델링 등 출구 전략의 부재\n아파트는 지은 지 30년이 지나면 재건축이나 재개발에 대한 기대감으로 가격이 다시 반등하는 사이클을 가집니다. 반면 오피스텔은 건축법상 업무시설로 분류되어 용적률이 이미 최대치(600~1000%)에 도달해 있는 경우가 대부분입니다. 상가와 오피스텔 소유주 간의 복잡한 이해관계, 낮은 사업성 때문에 노후화 이후 재건축을 추진하기가 현실적으로 불가능에 가깝습니다.",
      "3. 주택 수 산정과 세제 규제의 불리함\n오피스텔을 취득할 때는 주택 취득세율(1~3%)이 아닌 상가 취득세율(4.6%)을 적용받아 초기 진입 비용이 큽니다. 주거용으로 전입신고를 하여 사용하면 다주택자 판단 시 주택 수에 포함되어, 향후 아파트 청약이나 양도소득세 중과 등 세제 혜택에서 불리하게 작용합니다.",
      "4. 수익형 부동산과 차익형 부동산의 태생적 한계\n아파트는 매매차익(Capital Gain)을 목표로 하는 차익형 자산이며, 오피스텔은 매월 안정적인 임대료를 목적으로 하는 수익형(Cash Flow) 자산입니다. 오피스텔의 매매가는 기대 임대수익률에 의해 가격 상한선이 결정되는 경향이 강해, 인근 지역 아파트 가격이 급등할 때도 오피스텔은 소외되는 현상이 반복됩니다.",
      "결론적으로 오피스텔은 주거의 편의성과 현금 흐름을 확보하는 용도로는 유효하지만, 인플레이션을 방어하고 자산의 스노우볼 효과를 기대하는 '내 집 마련'의 관점에서는 치명적인 한계를 가집니다. 주거 만족도가 자산 가치의 상승과 반드시 비례하지 않는다는 점을 명확히 인지하고 접근해야 합니다."
    ],
    keyHighlights: [
      "오피스텔 대지지분이 아파트보다 극히 적어 건물 노후화 시 자산가치 방어 불가",
      "용적률 포화로 노후 후 재건축·리모델링 출구 전략 부재",
      "취득세율 4.6% 상가세율 적용 & 주거용 사용 시 주택 수 포함 페널티",
      "월세 수익형 자산(오피스텔) vs 시세 차익형 자산(아파트)의 태생적 가격 상한선 한계"
    ],
    press: "네이버페이 부동산 심층분석",
    reporter: "부동산 인사이트랩",
    timeAgo: "방금 전",
    publishedAt: "2026.08.26 10:50",
    views: "3.2만",
    comments: 128,
    likes: 492,
    imageUrl: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800&auto=format&fit=crop&q=80",
    imageCaption: "오피스텔(수익형) vs 아파트(차익형)의 자산가치 비교 분석",
    naverNewsUrl: "https://fin.land.naver.com/news",
    naverLandUrl: "https://fin.land.naver.com/news",
    isHot: true,
    isAiFeatured: true,
    relatedTags: ["#오피스텔_매매주의", "#대지지분", "#재건축출구전략", "#취득세4.6퍼센트", "#실거주vs자산가치"]
  },
  {
    id: "news-1",
    category: "REDEV",
