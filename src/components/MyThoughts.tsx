...
const THOUGHT_ARTICLES: ThoughtArticle[] = [
  {
    ...
    subtitle: '"오피스텔은 사는(Live) 곳이지, 사는(Buy) 것이 아니다"',
    ...
    contentParagraphs: [
      ...
      '“오피스텔은 사는(Live) 곳이지, 사는(Buy) 것이 아니다”라는 부동산 시장의 격언처럼, 매매 수요는 아파트에 비해 현저히 낮습니다. 주거 편의성에도 불구하고 오피스텔의 미래 가치 상승이 제한적인 구조적 이유는 다음과 같습니다.'
    ],
    keyPoints: [
      {
        num: 1,
        ...
        quote: '건물은 썩고 낡아 감가상각되지만, 땅의 가치는 영원히 우상향합니다.'
      },
      {
        num: 2,
        ...
        quote: '용적률이 이미 800%인 오피스텔을 누가 헐고 다시 지어줄 수 있을까요?'
      },
      {
        num: 3,
      ...
      },
      {
        ...
        description: '아파트는 매매차익(Capital Gain)을 목표로 하는 차익형 자산입니다. 반면 오피스텔은 매월 안정적인 임대료를 목적으로 하는 수익형(Cash Flow) 자산입니다. 오피스텔의 매매가는 기대 임대수익률에 의해 가격 상한선이 결정되는 경향이 강해, 인근 지역 아파트 가격이 급등할 때도 오피스텔은 소외되는 현상이 반복됩니다.',
        quote: '임대수익률 공식에 갇힌 자산은 결코 인플레이션을 뛰어넘는 시세 차익을 주지 못합니다.'
      }
    ],
    tableData: {
      ...
      rows: [
        ...
        { category: '취득세율', col1: '4.6% (지방교육세 등 포함 단일)', col2: '1.1% ~ 3.5% (1주택 실수요자 우대)' },
        { category: '환금성', col1: '낮음 (거래량 적음, 하락장 매도 곤란)', col2: '높음 (시장 유동성 및 거래량 풍부)' }
      ]
    },
    conclusion: '결론적으로 오피스텔은 주거의 편의성과 현금 흐름을 확보하는 용도로는 유효하지만, 인플레이션을 방어하고 자산의 스노우볼 효과를 기대하는 \'내 집 마련\'의 관점에서는 치명적인 한계를 가집니다. 주거 만족도가 자산 가치의 상승과 반드시 비례하지 않는다는 점을 명확히 인지하고 접근해야 합니다. 실거주는 역세권 가성비 전·월세로 누리고, 소중한 시드머니는 반드시 토지 지분이 살아 숨쉬는 아파트에 집중하십시오.'
  },
  {
    id: 'commute-vs-capital-gap',
    tag: '#거주와투자의분리',
    category: 'INSIGHT',
    categoryLabel: '실전 전략 인사이트',
    title: '직장 앞 낡은 빌라 매수 vs 상급지 갭투자 후 전월세, 10년 뒤의 격차',
    subtitle: '감정적 소비와 자본 투자를 섞는 순간 자산 증식은 멈춘다',
    ...
    contentParagraphs: [
      ...
      '초기 자본이 부족할수록 ‘실거주’와 ‘자산 매수’를 분리해야 자본이 갇히지 않습니다.'
    ],
    keyPoints: [
      {
        num: 1,
        ...
        quote: '부동산의 제1원칙은 "내가 원할 때 팔고 나올 수 있는가"입니다.'
      },
      {
        num: 2,
        title: '상급지 1채의 힘',
        description: '서울 핵심지 및 경기 1급지 대단지 아파트는 하락장에서 하방 경직성을 보이고 상승장에서 시장을 주도합니다.',
        quote: '똘똘한 1채가 어설픈 3채를 압도합니다.'
      }
    ],
    conclusion: '자본이 7억 미만일 때는 무리해서 마용성에 갈 수 없으므로, 8호선(다산/별내/구리)이나 신분당선 축의 실속 징검다리 아파트를 공략하는 것이 가장 스마트한 해법입니다.'
  },
  {
    id: 'dsr-and-stress-test',
    tag: '#대출한도전략',
    category: 'QNA',
    categoryLabel: '금융 실전 Q&A',
    title: '스트레스 DSR 2단계 시대, 영끌이 완전히 끝난 이유',
    subtitle: '소득 8천만 원 기준 대출 가능액이 8,000만 원 증발한 현실',
    publishedAt: '2026.08.15',
    readTime: '3분',
    views: '8.2천',
    likes: 194,
    summary: '금리가 내려가도 DSR 규제 때문에 대출 총액은 오히려 줄어들고 있습니다. 지금 부동산 시장은 대출 레버리지가 아니라 현금 보유력과 상환 안전성이 지배합니다.',
    contentParagraphs: [
      '스트레스 DSR은 미래 금리 변동 위험을 가산금리로 선반영하여 대출 한도를 원천 차단하는 제도입니다.',
      '월 상환 원리금이 가계 가처분 소득의 40%를 넘으면 어떤 금융 위기에도 버틸 수 없습니다.'
    ],
    keyPoints: [
      {
        num: 1,
        title: '금리가 내려가도 대출은 더 안 나온다',
        description: '수도권 스트레스 DSR 가산금리 1.2%p 적용으로 동일 연소득 대비 대출 가능액이 5천만~1억 원 축소되었습니다.',
        quote: '정책 금융(디딤돌, 신생아특례) 자격이 아니라면 자기자본 비중을 40% 이상 확보해야 합니다.'
      }
    ],
    conclusion: '대출을 풀로 당기는 위험한 전략 대신, 본인의 월 잉여현금흐름 내에서 원리금 상환이 가능한 안전 예산(Safe Budget)을 먼저 확정하십시오.'
  }
];
...
export const MyThoughts: React.FC = () => {
  ...
  const filteredArticles = THOUGHT_ARTICLES.filter(art => {
    if (selectedTag !== 'ALL' && art.tag !== selectedTag) return false;
    if (searchQuery.trim() !== '') {
  ...
  const allTags = ['ALL', '#오피스텔_매매주의', '#거주와투자의분리', '#대출한도전략'];
