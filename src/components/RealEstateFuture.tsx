    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6 animate-fadeIn">
      ...
      {activeTab === 'NEW_TOWNS' && (
        <div className="space-y-6 animate-fadeIn">
          ...
          {/* ===================================================================== */}
          {/* 🗺️ MAP VIEW 2: 구글/네이버맵 기반 수도권 광역 교통 노선망 & 인터랙티브 지도 */}
          {/* ===================================================================== */}
          {mapViewType === 'METRO' && (
            <div className="naver-card p-5 sm:p-7 bg-white border border-slate-200 shadow-sm space-y-5 animate-fadeIn">
              {/* Header */}
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 border-b border-slate-100 pb-3">
                <div>
                  <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-blue-50 text-[#0066ff] text-[11px] font-black mb-1">
                    ...
                    <span>네이버/카카오/구글 지도 스타일 수도권 광역 교통망 & 미래개발 인터랙티브 맵</span>
                  </div>
                  <h3 className="text-lg sm:text-xl font-black text-slate-900 flex items-center gap-2">
                    <span>수도권 광역 실물 지도 & 3기 신도시·메가 재개발 교통망</span>
                  </h3>
                  <p className="text-xs text-slate-500 font-medium">
                    실제 지리 좌표 기반 지도에서 <strong>신도시/재개발 마커 핀</strong>을 클릭하여 위치와 세부 스펙을 확인하고, <strong>네이버/위성 항공사진</strong>으로 자유롭게 전환할 수 있습니다.
                  </p>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <Layers className="w-3.5 h-3.5" />
                    <span>{selectedTown.shortName} 공식 토지이용계획도로 전환 ↗</span>
                  </button>
                </div>
              </div>

              {/* Real Leaflet Geographic Map Component */}
              <RealEstateGeographicMap
                towns={NEW_TOWNS_DATA}
                selectedTownId={selectedTownId}
                onSelectTown={handleSelectTown}
                selectedCategory={selectedZoneCategory}
              />
            </div>
          )}
      ...
      {activeTab === 'GLOSSARY' && (
        <div className="space-y-6 animate-fadeIn">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              },
              {
                ...
                tag: '3기 신도시 공급유형',
                desc: '3기 신도시 및 공공분양의 3대 핵심 공급 유형. 본인의 자금력과 소득에 맞춰 청약 전략을 세웁니다.',
          ...
          {/* ========================================================================= */}
          {/* 🏢 [부동산 실전 칼럼 & Q&A] 살기는 편한데 사기는 꺼려지는 오피스텔, 왜 자산가치는 오르지 않을까? */}
          {/* ========================================================================= */}
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-5">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-[11px] font-black text-rose-600 uppercase bg-rose-50 px-2.5 py-0.5 rounded-full border border-rose-200">
                    부동산 실전 Q&A 칼럼
                  </span>
                  <span className="text-[11px] font-bold text-slate-500">
                    실거주(Living) vs 자산가치(Buying)의 본질
                  </span>
                </div>
              ...
              <div className="p-3 bg-[#e8f8ee] rounded-2xl border border-[#03c75a]/30 text-xs font-black text-[#029f45] sm:max-w-xs shrink-0">
                💡 "오피스텔은 사는(Live) 곳이지, 사는(Buy) 것이 아니다"
              </div>
            </div>

            {/* Content summary */}
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed font-medium">
              역세권 입지, 풀옵션 빌트인, 우수한 보안으로 1~2인 가구의 실거주 만족도가 매우 높은 오피스텔. 그럼에도 불구하고 실수요자와 전문가 모두 "오피스텔은 전·월세로만 살고 매매는 하지 마라"고 조언하는 결정적 이유는 <strong>미래 자산가치 상승에 대한 기대가 아파트에 비해 압도적으로 낮기 때문</strong>입니다.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-2">
                <div className="flex items-center gap-2 text-rose-600 font-bold text-xs">
                  <span className="w-5 h-5 rounded-full bg-rose-100 text-rose-600 flex items-center justify-center font-black text-[11px]">1</span>
                  <span>토지 지분(대지지분)의 절대적 부족</span>
                </div>
                <h5 className="text-sm font-black text-slate-900">건물은 감가상각, 땅(토지)은 영구적 가치 상승</h5>
                <p className="text-xs text-slate-600 leading-relaxed font-medium">
                  부동산 상승의 본질은 토지 가치입니다. 오피스텔은 고용적률로 빽빽하게 지어져 세대당 대지지분이 극히 작습니다. 건물 노후화 시 건물 가치가 0에 수렴해 가격 방어가 불가능합니다.
                </p>
              </div>

              <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-2">
                <div className="flex items-center gap-2 text-amber-600 font-bold text-xs">
                  <span className="w-5 h-5 rounded-full bg-amber-100 text-amber-600 flex items-center justify-center font-black text-[11px]">2</span>
                  <span>재건축·리모델링 등 출구 전략의 부재</span>
                </div>
                <h5 className="text-sm font-black text-slate-900">이미 용적률이 최대치에 도달해 재건축 불가</h5>
                <p className="text-xs text-slate-600 leading-relaxed font-medium">
                  아파트는 30년 후 재건축 프리미엄이 붙지만, 오피스텔은 이미 용적률이 600~1,000%에 달해 사업성이 나오지 않으며 상가 소유주와의 갈등으로 재건축 추진이 사실상 불가능합니다.
                </p>
              </div>

              <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-2">
                <div className="flex items-center gap-2 text-indigo-600 font-bold text-xs">
                  <span className="w-5 h-5 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center font-black text-[11px]">3</span>
                  <span>주택 수 산정과 세제 규제의 불리함</span>
                </div>
                <h5 className="text-sm font-black text-slate-900">취득세 4.6% + 주거용 사용 시 주택 수 포함 페널티</h5>
                <p className="text-xs text-slate-600 leading-relaxed font-medium">
                  취득할 때는 주택 취득세율(1~3%)이 아닌 상가세율(4.6%)을 내야 하고, 주거용 전입신고 시 주택 수에 산정되어 향후 아파트 청약 및 1주택 비과세에서 배제됩니다.
                </p>
              </div>

              <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-2">
                <div className="flex items-center gap-2 text-emerald-600 font-bold text-xs">
                  <span className="w-5 h-5 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center font-black text-[11px]">4</span>
                  <span>수익형(Cash Flow) vs 차익형(Capital Gain)의 태생 한계</span>
                </div>
                <h5 className="text-sm font-black text-slate-900">매매가가 임대수익률 공식에 갇혀 상승 제한</h5>
                <p className="text-xs text-slate-600 leading-relaxed font-medium">
                  아파트는 시세 차익형 자산이지만 오피스텔은 월세 수익형 자산입니다. 오피스텔 매매가는 월세 수익률 상한선에 막혀 인근 아파트가 2배 뛸 때도 거의 오르지 못합니다.
                </p>
              </div>
              ...
              <table className="w-full text-left text-xs sm:text-sm border-collapse">
                <thead>
                  <tr className="bg-slate-100 border-y border-slate-200 text-slate-800 font-black">
                    ...
                    <th className="p-3 text-slate-600">🏢 주거용 오피스텔</th>
                    <th className="p-3 text-[#03c75a]">🏠 일반 아파트</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100 font-medium text-slate-700">
                  <tr className="hover:bg-slate-50">
                    <td className="p-3 font-bold text-slate-900">주요 목적</td>
                    <td className="p-3 text-slate-600">월세 임대수익 (수익형)</td>
                    <td className="p-3 font-bold text-[#0066ff]">시세 차익 (차익형)</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3 font-bold text-slate-900">대지지분</td>
                    <td className="p-3 text-rose-600 font-bold">매우 작음</td>
                    <td className="p-3 text-[#029f45] font-bold">상대적으로 큼</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3 font-bold text-slate-900">노후 시 출구전략</td>
                    <td className="p-3 text-rose-600">재건축 사실상 불가</td>
                    <td className="p-3 text-[#029f45] font-bold">재건축·리모델링 가능</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3 font-bold text-slate-900">취득세율</td>
                    <td className="p-3 text-slate-600">4.6% (상가세율)</td>
                    <td className="p-3 font-bold text-slate-900">1.1% ~ 3.5% (1주택 기준)</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3 font-bold text-slate-900">환금성</td>
                    <td className="p-3 text-slate-500">낮음 (거래량 적음)</td>
                    <td className="p-3 text-[#029f45] font-bold">높음 (시장 유동성 풍부)</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-[#e8f8ee] border border-[#03c75a]/30 flex items-start gap-3 text-xs sm:text-sm text-slate-800">
              ...
              <div>
                ...
                <p className="text-slate-700 leading-relaxed font-medium">
                  결론적으로 오피스텔은 주거의 편의성과 현금 흐름을 확보하는 용도로는 유효하지만, 인플레이션을 방어하고 자산의 스노우볼 효과를 기대하는 '내 집 마련'의 관점에서는 치명적인 한계를 가집니다. 주거 만족도가 자산 가치의 상승과 반드시 비례하지 않는다는 점을 명확히 인지하고, <strong>실거주는 가성비 전월세로 거주(Living)하고 매수(Buying)는 반드시 아파트에 집중</strong>하시기 바랍니다.
                </p>
              </div>
            </div>
