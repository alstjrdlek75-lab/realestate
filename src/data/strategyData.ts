...
export const REGIONAL_RECOMMENDATIONS: RegionalRecommendation[] = [
  ...
  // ==========================================
  {
    ...
    name: '구리시 (인창·수택·갈매)',
    subName: '현대건설 수택재개발(7,007세대), 구리역롯데캐슬시그니처, 수택E구역하이니티(3,022세대), e편한세상인창어반포레',
    city: '구리시',
    regionZone: 'GYEONGGI_EAST_NORTH',
    category: '8호선 구리역 잠실 18분 컷 + 현대건설 7,007세대 초대형 수택 재개발 + 토평2(2.2만세대) 한강변 메가벨트',
    matchScore: 95,
    avgPriceRange: '7.2억 ~ 12.5억 원 (84㎡ 네이버 실거래 기준)',
    gapPriceRange: '전세가율 60~65% (갭 2.8억 ~ 4.5억)',
    livingScore: 90,
    buyingScore: 92,
    representativeComplexes: ['수택동재개발(현대건설 7,007세대)', '수택E구역하이니티(3,022세대)', '구리역롯데캐슬시그니처', 'e편한세상인창어반포레'],
    concreteComplexes: [
      {
        id: 'gr-1',
        name: '구리 수택동 재개발 (현대건설·포스코)',
        tierTag: '수도권 최대 7,007세대 메가랜드마크',
        units: 7007,
        builtYear: 2030,
        stationDistance: '8호선 장자호수공원역·구리역 생활권',
        walkMinutes: 7,
        price84: '8.5억 ~ 9.8억 원 (예상 분양가)',
        gapPrice84: '3.5억 ~ 4.2억 원 (전세 5.5억~6.2억)',
        price59: '6.8억 ~ 7.5억 원 (예상 분양가)',
        keyHighlight: '현대건설·포스코 2.8조 수주 + 최고 49층 27개 동 + 해외 JERDE 특화설계 & 스카이 커뮤니티 6개소',
        recommendationTip: '대한민국 재개발 역사상 최대 규모 7,007세대. 8호선 잠실 15분대 진입과 토평2 한강변 메가시티 프리미엄 직결',
        targetPersona: '잠실/강남 20분대 출퇴근 및 하이엔드 신축 대단지 선호 무주택 실수요자',
        naverLandUrl: 'https://m.land.naver.com/search/result/%EA%B5%AC%EB%A6%AC%20%EC%88%98%ED%83%9D%EB%8F%99%20%EC%9E%AC%EA%B0%9C%EB%B0%9C'
      },
      {
        id: 'gr-2',
        name: '구리역 하이니티 리버파크 (수택E구역)',
        tierTag: '구리역 8호선 더블역세권 3,022세대',
        units: 3022,
        builtYear: 2028,
        stationDistance: '8호선·경의중앙선 구리역 도보 5분',
        walkMinutes: 5,
        price84: '8.8억 ~ 9.6억 원 (분양가)',
        gapPrice84: '3.2억 ~ 3.8억 원 (전세 5.6억~6.0억)',
        price59: '7.2억 ~ 7.8억 원',
        keyHighlight: 'DL이앤씨·GS건설·SK에코플랜트 3,022세대 + 롯데백화점 도보 슬세권',
        recommendationTip: '8호선 구리역 초역세권 대단지 메이저 브랜드로 잠실/강남 출퇴근 속도 원탑',
        targetPersona: '잠실/여의도 30분 컷 출퇴근 3040 맞벌이',
        naverLandUrl: 'https://m.land.naver.com/search/result/%EC%88%98%ED%83%9D%EC%9D%B4%EA%B5%AC%EC%97%AD'
      },
      {
        id: 'gr-3',
        name: 'e편한세상인창어반포레',
        tierTag: '초역세권 준신축 대장주',
        units: 632,
        builtYear: 2020,
        ...
        recommendationTip: '구리시 최고 입지. 즉시 입주 가능한 8호선 역세권 준신축',
    ...
    transitLines: ['8호선 구리역·장자호수공원역', '경의중앙선 구리역', 'GTX-B (갈매 연계)', '세종포천고속도로 (남구리IC)'],
    commuteTimeToGbd: '잠실 15~18분 / 강남역 25분 (8호선 직결)',
    commuteTimeToCbd: '종로/을지로 30분',
    commuteTimeToYbd: '여의도 40분',
    keyStrengths: ['현대건설 7,007세대 + 수택E구역 3,022세대 + 토평2(2.2만세대)로 이어지는 총 3.2만세대 메가타운', '8호선 잠실 15분 초직결', '롯데백화점 구리점 및 롯데마트 초슬세권'],
    trafficPoints: '8호선 환승 구리역·장자호수공원역(잠실 15분 컷), 강변북로 지하화/확장, 세종포천고속도로',
    schoolPoints: '장자호수공원 인근 수택동 전통 명문 학원가 및 인창고, 장자중 학군',
    cautionPoints: '재개발 단계별 이주/철거 기간 및 분양가 산정 추이 확인',
    strategyFit: 'STEPPING_STONE',
    quadrant: 'BALANCED_STARTER',
    tags: ['현대건설7007세대', '수택재개발', '잠실15분', '토평2시너지', '준서울']
  },
